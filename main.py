...
BOT_OWNER_ROLE = '👑Bot runer👑' # change to what you need
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="Confetti India")
        ...
        self.embed.set_footer(text='Just for fun#4278')
    ...
    async def update_embeds(self):
      #  global wrong
        ...
        self.embed.set_footer(text='Just for fun#2478')
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='with Just for fun | !ci'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjMzMjA3NjI5MzMzOTIxODAy.XaVAEQ.cZ9g3yt03Qo8W9yeqAo4ZS8sMTU'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NDg1NDIwNjY20TMyMTQyMTEy.XWXVFw.qCtfrUTJ8UBNc9wWimR4HdPorKQ',
                                   bot=False))
    loop.run_forever()
